module.exports = function(grunt) {
    ...
    uglify: {
        all: {
            files: {
                'assets/js/nutralife-products.min.js': ['assets/js/nutralife-products.js']
            },
            options: {
      ...
      test: {
        ...
        sass:   {
            all: {
                files: {
                    'assets/css/nutralife-products.css': 'assets/css/sass/nutralife-products.scss'
                }
            }
        },
            ...
            target: {
                options: {
                    exclude: ['build/.*', 'node_modules/*', 'assets/*'],
                        ...
                        potFilename: 'nutralife-products.pot', // Name of the POT file.
      ...
      compress: {
        main: {
            options: {
                mode: 'zip',
                    archive: './build/nutralife-products' + pkg.version + '.zip'
            },
            expand: true,
                cwd: 'build/',
                src: ['**/*'],
                dest: 'nutralife-products'
        }
    }   
